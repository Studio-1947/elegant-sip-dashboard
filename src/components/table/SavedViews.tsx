      ...
      {views.map((view) => {
        ...
        return (
          <a
            ...
            title={view.hint}
            className={`inline-flex h-7 items-center gap-1.5 rounded-sm border px-2 text-xs font-semibold ${
              selected
          ...
          >
            ...
            {typeof view.count === 'number' && (
              <span className={selected ? 'text-white/70' : 'text-muted'}>{view.count}</span>
            )}
          </a>
        )
      })}
