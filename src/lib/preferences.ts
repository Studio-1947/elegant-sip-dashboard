 ...
 *   Here  — how YOU like to look at it. Row density, a collapsed rail. Follows
 *           you between screens and survives a reload, and would be noise in a
 *           link: sending someone a table should not resize their rows.
 *
...
export type PreferenceKey = 'rail.collapsed' | 'table.density' | 'orders.view' | 'inventory.view'
